...
* `_full`: may contain mods which might not be allowed on some servers - use with caution.
...
- [x] [Zoomify (Zoom)](https://modrinth.com/mod/zoomify)
...
- [ ] [RightClickHarvest](https://modrinth.com/mod/rightclickharvest)
  - **Alternatives:**
    - [x] [Simple Harvesting](https://modrinth.com/mod/simple-harvesting)
